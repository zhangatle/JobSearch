...
namespace Dcat\Admin {
     ...
     * @property Grid\Column|Collection send_sender
     * @property Grid\Column|Collection send_wxid
     ...
     * @method Grid\Column|Collection send_sender(string $label = null)
     * @method Grid\Column|Collection send_wxid(string $label = null)
     ...
     * @property Show\Field|Collection send_sender
     * @property Show\Field|Collection send_wxid
     ...
     * @method Show\Field|Collection send_sender(string $label = null)
     * @method Show\Field|Collection send_wxid(string $label = null)
